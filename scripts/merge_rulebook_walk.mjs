...
const meta = {
  ...
  transport: "in-process (no engine, no sentence question) — per-decision wall time of the depth-3 search, split evenly over the options (per_option_ms = decision_ms / options)",
  policy: "argmax",
  seed: info.seed,
  stream: info.stream,
